...
class ExCamera extends PerspectiveCamera
{
    ...
    public var _mouseX:Float = 0;
    public var _mouseY:Float = 0;
    ...
    public var amp    	:Float = 3000.0;
	public var radX   	:Float = -Math.PI / 2;
	...
	public function getDist(w:Float):Float {
		
		var hh:Float 	= w / this.aspect * 0.5;
		var rad:Float 	= ( this.fov * Math.PI / 180 ) / 2;
		
		var dist:Float = hh / Math.tan( rad );
		return dist;
	...
	private function onMouseWheelFF(e):Void{
        ...
        if(this.amp>10000)this.amp=10000;
        if(this.amp<500)this.amp=500;
		*/
    }
